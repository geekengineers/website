      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/learn" className="text-gray-400 hover:text-primary transition-colors text-sm">
                  Learning Resources
                </Link>
              </li>
              <li>
                <Link href="/join" className="text-gray-400 hover:text-primary transition-colors text-sm">
                  Join Community
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">© 2025 Geek Engineers Community. All rights reserved.</div>
