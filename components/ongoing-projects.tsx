    ...
    <section className="pt-10 pb-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">Ongoing Projects</h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Discover our active open source projects and contribute to meaningful software that makes a difference in
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          {ongoingProjects.map((project, index) => (
            <div
              key={index}
              className="backdrop-blur-sm bg-white/5 rounded-xl p-8 border border-white/10 hover:border-red-500/30 transition-all duration-300 group"
            >
              {/* Project Header */}
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="text-right">
                  ...
                  <div className="text-sm text-red-400">{project.lastUpdate}</div>
                </div>
              </div>
              ...
              <div className="mb-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm text-red-400 font-medium">{project.progress}%</span>
                </div>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-white/10">
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-400">{project.contributors} contributors</span>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <Link
                    href="/join"
                    className="px-4 py-2 border border-red-500 text-red-400 hover:bg-red-500/10 rounded-lg transition-colors text-sm font-medium"
                  >
                    Contribute
                  </Link>
                </div>
        ...
        <div className="text-center">
          <div className="backdrop-blur-sm bg-white/5 rounded-2xl p-12 border border-white/10">
            <h3 className="text-2xl font-semibold mb-4 text-white">Want to Start a New Project?</h3>
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              Have an innovative idea that could benefit the developer community? Propose your project and gather
              contributors from our passionate community.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/join"
                className="px-8 py-4 bg-red-500 hover:bg-red-600 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105"
              >
                Propose Project
              </Link>
              <Link
                href="/projects"
                className="px-8 py-4 border border-red-500 text-red-400 hover:bg-red-500/10 font-semibold rounded-lg transition-all duration-300"
              >
                View All Projects
              </Link>
            </div>
