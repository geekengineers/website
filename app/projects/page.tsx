        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Discover our community-driven projects and contribute to
              meaningful open source software.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              <div
                key={index}
                className="backdrop-blur-sm bg-white/5 rounded-xl p-8 border border-white/10 transition-all duration-300"
              >
                ...
                <div className="mb-6">
                  <div className="flex flex-wrap gap-2">
                    {project.tech.map((tech, techIndex) => (
                      <span
                        key={techIndex}
                        className="px-3 py-1 bg-primary/90 text-primary-foreground rounded-full text-sm"
                      >
                        {tech}
                      </span>
                    ))}
          ...
          <div className="mt-16 text-center">
            <div className="backdrop-blur-sm bg-white/5 rounded-2xl p-12 border border-white/10">
              ...
              <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
                We're always looking for new open source projects to collaborate
