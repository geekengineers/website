...
export default function Learn() {
  const resources = [
    ...
    },
    {
      ...
      items: [
        {
          title: "Contributing to OSS: A Complete Guide",
          type: "Course",
          difficulty: "Beginner",
        },
        {
        ...
        {
          title: "License Selection and Legal Considerations",
          type: "Guide",
          difficulty: "Intermediate",
        },
      ],
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Comprehensive resources, tutorials, and workshops created by our
              community to help you level up your skills.
            </p>
          </div>
                    ...
                    {category.items.map((item, itemIndex) => (
                      ...
                      >
                        <div className="flex items-start justify-between mb-2">
                          ...
                          <span className="text-xs text-primary bg-red-500/20 px-2 py-1 rounded">
                            {item.type}
                          </span>
                        </div>
                        <span
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {workshops.map((workshop, index) => (
                ...
                >
                  ...
                  <button className="w-full py-2 border border-red-500 text-primary hover:bg-red-500/10 rounded-lg transition-colors text-sm font-medium">
                    Join Workshop
                  </button>
                </div>
              ))}
          ...
          <div className="backdrop-blur-sm bg-white/5 rounded-2xl p-12 border border-white/10 text-center">
            ...
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              Have expertise to share? Create tutorials, write guides, or host
              workshops for the community. Teaching others is one of the best
              ways to solidify your own understanding.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="px-8 py-4 border border-red-500 text-primary hover:bg-red-500/10 font-semibold rounded-lg transition-all duration-300">
                Submit Content
              </button>
            </div>
          </div>
